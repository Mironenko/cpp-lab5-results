...
//а так же Вам может показаться, что это писал невменяемый человек, либо же, что сие творение было написано внеземным разумом
//Так или иначе, чтение этого кода может привести к навязчивому желанию выдрать себе глаза в процессе чтения или
//убить того, кто это сделал, а так же, вероятно, вызывает психоз и эпилептические припадки.
